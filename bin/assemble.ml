    ...
    match inst with
        ...
        | Tac.Call (name, params, dst) ->
            ...
            let stackInstrs = List.map (fun x -> let arg = parseOperand x in match arg with
                ...
                | Asmt.Pseudo _ | Asmt.Stack _ | Asmt.Data _ -> [Asmt.Mov (arg, Asmt.Reg Asmt.RAX);
...
let parseProgram tacky =
    ...
    let rec iter tls = match tls with
        ...
        | Tac.StaticVariable (name, is_global, 0l) :: rest ->
            bss := (name, is_global) :: !bss; iter rest
        | Tac.StaticVariable (name, is_global, init) :: rest ->
            data := (name, init, is_global) :: !data; iter rest
        | [] -> ()
...
let replacePseudos (name, instructions, is_global) =
    ...
    in (name, newInstructions, is_global), roundAlloc !offset
...
let fixUp (name, instructions, is_global) allocateBytes =
    let rec fixErroneous instrs = match instrs with
        ...
        | h :: t -> begin match h with
            ...
            | Asmt.Binary (Asmt.Sal as op, (Asmt.Data _ as k), d)
            | Asmt.Binary (Asmt.Sar as op, (Asmt.Data _ as k), d) ->
            ...
            | Asmt.Mov ((Asmt.Stack _ as s), (Asmt.Data _ as d))
            | Asmt.Mov ((Asmt.Data _ as s), (Asmt.Stack _ as d))
            | Asmt.Mov ((Asmt.Data _ as s), (Asmt.Data _ as d)) ->
            ...
            | Asmt.Binary (binop, (Asmt.Stack _ as s), (Asmt.Data _ as d))
            | Asmt.Binary (binop, (Asmt.Data _ as s), (Asmt.Stack _ as d))
            | Asmt.Binary (binop, (Asmt.Data _ as s), (Asmt.Data _ as d)) ->
            ...
            | Asmt.Cmp ((Asmt.Stack _ as s), (Asmt.Data _ as d))
            | Asmt.Cmp ((Asmt.Data _ as s), (Asmt.Stack _ as d))
            | Asmt.Cmp ((Asmt.Data _ as s), (Asmt.Data _ as d)) ->
